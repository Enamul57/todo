                      ...
                      <div class="col-lg-6  mx-auto">
                          <div class="p-5">
                              <div class="text-center">
                                  <h1 class="h4 c-title mb-4">Test</h1>
                              </div>
                              <form class="user login_user" @submit.prevent="register">
                                  <div class="form-group">
                                    <label class="label_style">Enter Your Username</label>
                                      <input type="text" class="form-control form-control-user input_form" id=""
                                          aria-describedby="emailHelp" placeholder="Enter User Name..." v-model="form.username">
                                          <small class="text text-danger" v-if='errors.username'>{{errors.username[0]}}</small>
                                                                           </div>
                                  <div class="form-group">
                                    <label class="label_style">Enter Your Email</label>

                                      <input type="email" class="form-control form-control-user input_form" id=""
                                          aria-describedby="emailHelp" placeholder="Enter Email Address..." v-model="form.email">
                                  </div>                                          <small class="text text-danger" v-if="errors.email">{{errors.email[0]}}</small>

                                  <div class="form-group">
                                    <label class="label_style">Enter Your Password</label>

                                      <input type="password" class="form-control form-control-user input_form"
                              ...
                              <small class="text text-danger" v-if="username_exists">Username Already exists</small>

                                  <button class="btn loginBtn btn-user btn-block">
                                      Registration
                                  </button>
                                  <hr>
